...
export default function Chance({state, dispatch, getUrl, group , year}) {
    ...
    return <div className={'w-100 container'}>
        ...
        <div className={'box p-lg-5 pt-5 p-2 mb-3 w-100 d-flex flex-column align-items-center'}>
            ...
            'خوشبینانه: در سال های گذشته، با رتبه هایی که کمی بهتر از رتبه شماست در این رشته محل ها ها قبول شده اند. پس اگر خوش شانس باشید شاید شما نیز قبول شوید.\n' +
            'کم احتمال: در سال های گذشته، با رتبه هایی بسیار بهتر از رتبه شما در این رشته محل ها ها قبول شده اند. بنابراین احتمال قبولی شما بسیار بسیار پایین است.\n' +
